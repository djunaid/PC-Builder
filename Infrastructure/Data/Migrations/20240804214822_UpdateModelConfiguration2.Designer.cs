...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20240804214822_UpdateModelConfiguration2")]
    partial class UpdateModelConfiguration2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PCBuilder.Domain.Entities.PCComponent", b =>
                {
                    ...
                    b.Property<byte[]>("SystemTimeStamp")
                        .IsConcurrencyToken()
                        .IsRequired()
            ...
            modelBuilder.Entity("PCBuilder.Domain.Entities.PCComponentTag", b =>
                {
                    ...
                    b.HasKey("PCComponentId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("PCComponentTag");
                });
            ...
            modelBuilder.Entity("PCBuilder.Domain.Entities.PCComponentTag", b =>
                {
                    ...
                    b.HasOne("PCBuilder.Domain.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
